export const zh = {
  ...
  'chat.copied': '✅ 已复制！',
  'chat.archiveNotice': 'Claude Code 本地记录保留约 30 天（参与训练时 5 年）；Codex 和 Gemini CLI 默认永久保留（Codex 可配置大小上限，Gemini 可配置保留天数）。Muxvo 已自动归档 Claude Code 记录到 ~/.muxvo/chat-archive/ 永久保留。所有数据仅保存在你的本地电脑。',
