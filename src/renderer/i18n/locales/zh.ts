export const zh = {
  ...
  'tour.step1.desc': '点击 + 按钮创建一个新的终端会话。你可以同时运行多个终端，最多支持 20 个。',
  'tour.step2.title': '平铺视图',
  'tour.step2.desc': '终端以网格方式平铺排列。拖拽标题栏可以重新排序，拖拽分隔线可以调整大小。',
  'tour.step3.title': '聚焦终端',
  'tour.step3.desc': '点击蓝色按钮将终端最大化为聚焦模式，其他终端显示在右侧边栏。双击标题栏也可以切换。',
  'tour.step4.title': '重命名终端',
  'tour.step4.desc': '点击"命名..."为终端设置自定义名称，方便在多个终端间快速识别。',
  'tour.step5.title': '打开文件',
  'tour.step5.desc': '点击"文件"按钮打开当前终端工作目录的文件浏览器，可以快速查看和编辑项目文件。',
