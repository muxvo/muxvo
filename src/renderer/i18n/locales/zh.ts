export const zh = {
  ...
  'settings.dockBadgeOffDesc': '不提醒',
  'settings.dockBadgeRealtime': '实时',
  'settings.dockBadgeRealtimeDesc': '状态变化时立即更新',
  'settings.dockBadgeTimed': '定时',
  'settings.dockBadgeTimedDesc': '每隔 N 分钟检查一次',
  'settings.dockBadgeInterval': '检查间隔',
  'settings.dockBadgeIntervalUnit': '分钟',
  'settings.defaultTerminalCwd': '终端默认路径',
  'settings.defaultTerminalCwdDesc': '新建终端时使用的初始工作目录',
  'settings.defaultTerminalCwdPlaceholder': '默认为用户主目录',
  'settings.browse': '浏览',
  'settings.clear': '清除',
  'settings.zoom': '缩放',
  'settings.enabled': '启用',
