export const en = {
  ...
  'tour.step1.desc': 'Click the + button to create a new terminal session. You can run up to 20 terminals simultaneously.',
  'tour.step2.title': 'Tile View',
  'tour.step2.desc': 'Terminals are arranged in a grid layout. Drag title bars to reorder, drag dividers to resize.',
  'tour.step3.title': 'Focus Terminal',
  'tour.step3.desc': 'Click the blue button to maximize a terminal into focus mode. Other terminals appear in the sidebar. Double-click the title bar also works.',
  'tour.step4.title': 'Rename Terminal',
  'tour.step4.desc': 'Click "Name..." to give a terminal a custom name for easy identification across sessions.',
  'tour.step5.title': 'Open Files',
  'tour.step5.desc': 'Click the "File" button to open a file browser for the terminal\'s working directory. Quickly browse and edit project files.',
