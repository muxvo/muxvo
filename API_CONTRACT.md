...
- **位置**: `main/services/terminal/manager.ts:117`
- **调用函数**: `terminals.delete()`
- **请求参数**: 无额外参数

#### `GET {变量:id}`

- **位置**: `main/services/terminal/manager.ts:139`
- **调用函数**: `terminals.get()`
- **请求参数**: 无额外参数
...
| DELETE | `{变量:id}` | API 服务 | main/services/terminal/manager.ts:117 |
| GET | `{变量:id}` | API 服务 | main/services/terminal/manager.ts:139 |
