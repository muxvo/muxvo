...
> 存储在本地 `~/Library/Application Support/Muxvo/promo-pages/{skill-dir-name}.json`，发布后同步到 GitHub Pages。
...
> 存储在本地 `~/Library/Application Support/Muxvo/portfolio.json`，V2-P3 阶段发布到 `skill.muxvo.com/@username`。
