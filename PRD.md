...
| SP | Skill 宣传页 | 用户发布 skill 时自动生成精美宣传页，展示 skill 能力、使用说明、作者信息。支持一键发布到 GitHub Pages 生成可分享链接，可贴到简历/社交媒体。后续迭代为个人技能作品集 | V2-P0 | 痛点5 |
