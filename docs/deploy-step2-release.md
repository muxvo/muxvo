...
| `mac.identity` | `li rao (M7T6PJ8YJZ)` | 与 Developer ID 一致 |
| `mac.notarize.teamId` | `M7T6PJ8YJZ` | 公证 Team ID |
...
| `APPLE_TEAM_ID` | `M7T6PJ8YJZ` | 公证步骤 (env) |
...
1. **Apple Developer Program 已加入** (Team ID: M7T6PJ8YJZ)
...
# 2. 找到 "Developer ID Application: li rao (M7T6PJ8YJZ)"
